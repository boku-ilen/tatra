...
# Usage: python gpscoord.py (ArcGIS arcpy library has to be present)
...
# set environment
env.workspace = "E:\POREM\INPUT"
outLocation = "E:\POREM\OUTPUT"
#schemaType = "NO_TEST"
#fieldMappings = ""
#subtype = ""
...
try:
    ...
    inputSHPs = arcpy.ListFeatureClasses("","POINT")
    inputDBFs = arcpy.arcpy.ListTables('*', 'dBASE')
